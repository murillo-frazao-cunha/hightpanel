...
export const Icon = ({ name, className }: { name: string, className?: string }) => {
    const baseIcons: { [key: string]: React.ReactNode } = {
        ...
        skull: <><path d="M12 2c4.5 0 8 3.3 8 7.5 0 2.4-1 4.6-2.8 6.05v3.45a1 1 0 0 1-1 1h-1.2V18h-2v2h-2v-2h-2v2H7.8a1 1 0 0 1-1-1v-3.45C5 14.1 4 11.9 4 9.5 4 5.3 7.5 2 12 2Z" /><circle cx="9" cy="10" r="1.4" /><circle cx="15" cy="10" r="1.4" /><path d="M12 12.5l1 2h-2l1-2Z" /><line x1="10" y1="16" x2="10" y2="18" /><line x1="12" y1="16" x2="12" y2="18" /><line x1="14" y1="16" x2="14" y2="18" /></>,
